...
return [
    ...
    */
    ...
    //Zmiana poniżej jak powinno wygladać a jak zmieniłem
    //'required_without'     => 'Pole :attribute jest wymagane gdy :values nie jest obecny.',
    'required_without'     => 'Pole :attribute jest wymagane gdy :values nie jest zaznaczony.',
    //Zmiana jak wygladać powinno a jak wygląda
    //'required_without_all' => 'Pole :attribute jest wymagane gdy żadne z :values nie są obecne.',
    'required_without_all' => 'Pole :attribute jest wymagane gdy żadne z :values nie są uzupełnione.',
    ...
    */
    ...
    'attributes' => [
        ...
        'categorymachines' => 'kategoria maszyny',
        'machine_id' => 'rejestracja',
        'name_p' => 'nazwa produktu',
        'weight' => 'waga',
        'categoryUnit' => 'rodzaj masy',
        'categoryStorehouse' => 'rodzaj materiału',
        'number_plot' => 'numer działki',
        'city' => 'miasto',
        'area_hectare' => 'wielkosć działki',
        'plot_typeId' => 'typ działki',
        'start_rent' => 'początek dzierżawy',
        'end_date' => 'koniec dzierżawy',
        'year_rent' => 'czas trwania',
        'ground_rent_cost' => 'koszt dzierżawy',
        'farm_id' => 'numer farmy',
        'place_id' => 'numer siedziby',
        'check_number' => 'urodzone na miejscu',
        'old_farm_id' => 'numeru starej farmy',
        'old_place_id' => 'numeru starej siedziby',
        'old_name' => 'imienia',
        'old_surname' => 'nazwiska',
        'sex' => 'płeć',
        'breed' => 'rasa',
        'number_mother' => 'numer matki',
        'number_father' => 'numer ojca',
        'date_marking' => 'data oznakowania',
        'date_birth' => 'data urodzenia',
        'natural_death' => 'naturalna śmierć',
        'slaughter_date' => 'ubicie',
        'animal_id' => 'numer zwierzęcia'
    ],
];
